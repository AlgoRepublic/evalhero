...
export interface EditFormTemplateFolderModalProps {
  open: boolean;
...
const EditFormTemplateFolderModal: React.FC<EditFormTemplateFolderModalProps> = ({
  open,
  folderId,
  onClose,
  onSuccess,
  ...
  const { data, isLoading: loadingFolder } = useGetFormTemplateFolderQuery(folderId!, {
    skip: !folderId || !open,
  });
  const [updateFolder] = useUpdateFormTemplateFolderMutation();
...
export default EditFormTemplateFolderModal;
