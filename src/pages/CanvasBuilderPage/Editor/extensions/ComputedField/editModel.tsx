import { Form, Input, InputNumber, Modal, Select, Row, Col, Space, Button } from 'antd';
// import TagSelector from '../../components/TagSelector';

const { Option } = Select;

const ComputedEditModal = ({
  open,
  onClose,
  nodeAttrs,
  onSave,
    ...
    >
      ...
      >
        ...
        <Form.Item
          name="expression"
          label="Expression"
          tooltip="Use other fieldIds as variables (e.g. score_a + score_b * 0.5)"
        >
          <Input.TextArea rows={4} />
        </Form.Item>

        <Form.Item name="precision" label="Precision (decimal places)">
        ...
        <Form.Item
          ...
          tooltip="Pre-populate this field from URL query parameter. Enter the query parameter key (e.g., 'computed' for ?computed=123)"
        >
          <Input placeholder="e.g. computed, result" />
        </Form.Item>
...
export default ComputedEditModal;
